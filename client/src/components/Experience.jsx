  ...
  const experiences = [
    {
      ...
      description: 'Leading the development of scalable web applications using React and Node.js. Mentoring junior developers and implementing best practices.',
      achievements: [
    ...
    },
    {
      ...
      description: 'Developed and maintained multiple client-facing applications. Collaborated with design team to create intuitive user experiences.',
      achievements: [
    ...
    },
    {
      ...
      period: '2018 - 2020',
      location: 'Remote',
      description: 'Created responsive and interactive web interfaces. Worked closely with clients to understand requirements and deliver solutions.',
      achievements: [
